...
val launchIntent = getPackageManager().getLaunchIntentForPackage("com.delivery.moyoboy");
if (launchIntent != null) { 
    startActivity(launchIntent);//null pointer check in case com.delivery.moyoboy was not found
}   }
