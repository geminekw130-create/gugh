...
Future<void> firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  if (message.data['push_type'].toString() == 'meta-request') {
    AndroidIntent intent = AndroidIntent(
      action: 'action_view',
      package: 'com.delivery.moyoboy', // Your app's com.delivery.moyoboy
      componentName:
          'com.delivery.moyoboy.MainActivity', // Replace with your app's com.delivery.moyoboy
    );
    await intent.launch();
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
        ...
        child: MaterialApp(
          ...
          title: 'To Chegando Delivery Motoboy',
          theme: ThemeData(),
